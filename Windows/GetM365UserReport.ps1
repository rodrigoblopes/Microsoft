...
$ExportCSV = ".\M365UserReport_$((Get-Date -format yyyy-MMM-dd-ddd` hh-mm-ss` tt).ToString()).csv"
$ExportResult=""   
$ExportResults=@()  
...
$PrintedUser=0
#retrieve users
$RequiredProperties=@('UserPrincipalName','DisplayName','EmployeeId','CreatedDateTime','AccountEnabled','PasswordPolicies','Department','JobTitle','RefreshTokensValidFromDateTime','SigninActivity')
